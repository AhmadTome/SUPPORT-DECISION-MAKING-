...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <form action="../database/addMaterial.php" method="post" style="padding: 50px" enctype="multipart/form-data">
                ...
                <div class="form-group mb-lg">
                    ...
                    <div class="input-group input-group-icon">
                        <input name="mat_name" type="text" class="form-control input-lg text-right" placeholder="اسم المادة"
                               required/>
                    </div>
                </div>
                ...
                <div class="form-group mb-lg">
                    ...
                    <div class="input-group input-group-icon">
                        <textarea name="mat_desc" class="form-control" rows="8"></textarea>
                    </div>
                </div>

                <div class="form-group mb-lg">
                    <label class="pull-right">المرفقات <span class="required-star">*</span></label>
                    <div class="input-group input-group-icon">
