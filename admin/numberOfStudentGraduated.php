...
<html class="fixed">
<head>
    <title> عدد الطلاب الخريجين اخر خمس سنوات</title>
    <!-- Basic -->
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    <label class="pull-right"> عدد الطلاب الخريجين اخر خمس سنوات</label>
...
// Check connection
    ...
    $query = "SELECT count(*) as count FROM `users` where `gradulation_year` > SUBDATE(CURDATE(), INTERVAL 5 year)";
