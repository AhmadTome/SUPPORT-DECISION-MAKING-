...
<html class="fixed">
<head>
    <title> عدد الساعات الدراسية كل فصل</title>
    <!-- Basic -->
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    <label class="pull-right" style="font-size: 24px;">عدد الساعات الدراسية كل فصل </label>
                    <div class="input-group input-group-icon">
                        <table class="table text-right"  dir="rtl">
                            <thead >
                            <tr >
                                <th>الاسم</th>
                                <th>عدد الساعات الدراسية للفصل</th>
                            </tr>
                            </thead>
                            <br>
                            ...
                            for ($i=0;$i<count($info);$i++){
                                echo '      <tr>
                                                <td>'. $info[$i]["name"] .'</td>
                                                <td>'. $info[$i]["hour_number_each_semester"] .'</td>
                                           </tr>';
                            }
...
// Check connection
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            array_push($info,
                ["name" => $row["name"],"hour_number_each_semester" => $row["hour_number_each_semester"]
                ]);
        }
        return $info;
        //echo $sl_number;
