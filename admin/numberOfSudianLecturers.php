...
<html class="fixed">
<head>
    <title>عدد المحاضرين السعوديين</title>
    <!-- Basic -->
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    <label class="pull-right">عدد المحاضرين السعوديين </label>
...
// Check connection
    ...
    $query = "SELECT COUNT(*) as count FROM `users` WHERE `type` = 'supervisor' and  `country`='Saudi Arabia'";
