...
<html class="fixed">
<head>
    <title>تعديل معلومات القسم</title>
    <!-- Basic -->
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    ...
                    <div class="input-group input-group-icon">
                        <select class="form-control" id="category_select" name="category_select">
                            <option class="text-right" selected disabled>--- اختار القسم ---</option>
                            <?php
                ...
                <div class="form-group mb-lg">
                    ...
                    <div class="input-group input-group-icon">
                        <input name="cat_name" id="cat_name" type="text" class="form-control input-lg text-right" placeholder="اسم القسم"
                               required/>
                    </div>
                </div>
