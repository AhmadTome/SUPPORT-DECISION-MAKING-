        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    <label class="pull-right" style="font-size: 24px;">عدد القاعات </label>
...
// Check connection
    ...
    $query = "SELECT department , COUNT(department) as count FROM `class_room` Group By department";
