...
<html class="fixed">
<head>
    <title> عدد الطلاب في كل قسم</title>
    <!-- Basic -->
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    <label class="pull-right" style="font-size: 24px;">عدد الطلاب في كل قسم </label>
...
// Check connection
    ...
    $query = "SELECT department , COUNT(department) as count FROM `users` WHERE `type`='student' Group By department";
    ...
    if ($result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            array_push($info,
                ["count" => $row["count"],"department" => $row["department"]
                ]);
        }
        return $info;
        //echo $sl_number;
