        ...
        <div class="wrap-login100">
            ...
            <form action="../database/editcatinfo.php" method="post" style="padding: 50px;">
                <div class="form-group mb-lg">
                    <label class="pull-right" style="font-size: 24px;">معلومات الطلاب</label>
                        ...
                        <table class="table text-right"  dir="rtl">
                            ...
                            for ($i=0;$i<count($info);$i++){
                                echo ' <tr>
                                                ...
                                                <td>'. $info[$i]["email"] .'</td>
                                                <td>'. $info[$i]["age"] .'</td>
                                                <td>الطالب : '. $info[$i]["name"] .'<br/> من مواليد '. $info[$i]["age"] .'<br/>   الجنس '. $info[$i]["gender"] .'  <br/>  المستوى التعليمي '. $info[$i]["level"] .'
